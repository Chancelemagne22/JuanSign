  ...
  if (error) {
    return (
      <div className="flex items-center justify-center h-64">
        <p style={{ fontFamily: FONT, color: '#B91C1C', fontSize: '1.1rem' }}>{error}</p>
      </div>
    )
  }
                    ...
                    return (
                      <div
                        ...
                        style={{
                          ...
                          borderColor: DIVIDER,
                          backgroundColor: isLow ? '#FEF2F2' : 'transparent',
                        }}
                      >
                        <span style={{ fontFamily: FONT, color: isLow ? '#B91C1C' : BROWN, fontSize: '0.95rem' }}>
                          {row.levelName}
                        </span>
                        <span className="text-center" style={{ fontFamily: FONT, color: isLow ? '#B91C1C' : BROWN, fontSize: '0.95rem' }}>
                        ...
                        <span className="text-center" style={{ fontFamily: FONT, color: isLow ? '#B91C1C' : BROWN, fontSize: '0.95rem', fontWeight: isLow ? 700 : 400 }}>
                          {row.passRate}%
                        </span>
                      </div>
                    )
                  ...
                  data.learnerPerformance.map((row, i) => (
                    ...
                    >
                      ...
                      <span
                        ...
                        style={{
                          fontFamily: FONT,
                          color: row.status === 'Passed' ? '#16A34A' : '#B91C1C',
                          fontSize: '0.95rem',
                          fontWeight: 600,
                        }}
                      >
          ...
          <div className="rounded-2xl p-5" style={{ backgroundColor: CREAM }}>
            ...
            <div className="flex flex-col gap-3">
              <button
                ...
                onMouseEnter={(e) => {
                  if (data) (e.currentTarget as HTMLButtonElement).style.backgroundColor = '#F4E0B0'
                }}
                onMouseLeave={(e) => {
