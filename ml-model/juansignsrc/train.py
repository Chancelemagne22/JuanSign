...
# ── CONFIG ────────────────────────────────────────────────────────────────────
CLASS_NAMES = ["friday","monday","saturday","sunday","thursday","tuesday","wednesday"] # Start with Pilot
NUM_CLASSES = len(CLASS_NAMES)

FRAME_ROOT      = "C:/Users/Administrator/JuanSign/ml-model/processed_output/frame_extracted"
MODEL_SAVE_PATH = "./juansignmodel_days/juansign_model_v2_2.pth"
LOG_DIR         = "./runs_days/v2_2_pilot"

# RTX 2070 Optimizations
BATCH_SIZE          = 4      # ResNet50 is heavy; start with 4 (or 2 if it crashes)
EPOCHS              = 50
LEARNING_RATE       = 1e-4   
FREEZE_EPOCHS       = 5    # Early unfreeze for better visual alignment
