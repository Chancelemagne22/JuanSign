...
if IS_MODAL:
    ...
    BATCH_SIZE      = 16  # We can use a bigger batch size on Modal GPUs (A10G/A100)
else:
    ...
    BATCH_SIZE      = 4   # Limited by RTX 2070 8GB VRAM
...
def train():
    ...
    for epoch in range(1, EPOCHS + 1):
        # Differential LR Unfreeze logic
        ...
        print(f"Epoch {epoch:02d} | Train: {train_acc:.1f}% | Val: {val_acc:.1f}%")
